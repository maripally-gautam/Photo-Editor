...
export const MagicWandIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="m4.94 18.528 1.414-1.414" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.121 21.353l1.414-1.414" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M18.528 4.94l1.414-1.414" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M21.353 2.121l-1.414 1.414" />
    </svg>
);
