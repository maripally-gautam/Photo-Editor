...
import { SparklesIcon, UploadIcon, DownloadIcon, ArrowPathIcon, ExclamationTriangleIcon, PencilSquareIcon, PhotoIcon } from './components/icons';
                        ...
                        <div className="flex flex-col space-y-4">
                            ...
                            <div className="aspect-square bg-gray-800 rounded-xl overflow-hidden shadow-lg flex items-center justify-center relative">
                                ...
                                {!isLoading && !error && generatedImage && (
                                    <img src={`data:image/png;base64,${generatedImage}`} alt="Edited" className="w-full h-full object-contain" />
                                )}
                                {!isLoading && !error && !generatedImage && (
                            ...
                            {generatedImage && !isLoading && (
                                <a href={`data:image/png;base64,${generatedImage}`} download="edited-photo.png" className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-green-600 hover:bg-green-700 shadow-lg transition-all transform hover:scale-105">
